  ...
  return (
    ...
    >
      <div className='w-full h-[58px] px-[16px] py-[30px] lg:px-[48px] lg:py-[30px] lg:h-[80px] md:px-[40px] md:py-[30px] md:h-[68px] inline-flex justify-between items-center'>
        <Link
          href='/'
          className='h-[24px] md:h-[30px] lg:h-[36px] w-auto relative flex justify-center items-center aspect-[156/36]'
        >
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 156 36' fill='white'>
            <g>
              <path
