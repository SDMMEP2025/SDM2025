...
export function Header({ useBlendMode = true }: HeaderProps) {
  ...
  const toggleMobileMenu = () => {
    if (isMobileMenuOpen) {
      ...
      setTimeout(() => setBlendMode('difference'), 300)
    } else {
      setBlendMode('normal')
  ...
  useEffect(() => {
    ...
    const events: (keyof WindowEventMap)[] = ['orientationchange']
    events.forEach((ev) => window.addEventListener(ev, forceRepaint))
    return () => {
      events.forEach((ev) => window.removeEventListener(ev, forceRepaint))
    }
  }, [isMobileMenuOpen])
    ...
    <div className="w-full h-0 z-30">
      ...
      >
        <div className="pointer-events-auto">
          <div className="w-full h-[58px] px-[16px] py-[30px] md:px-[40px] md:py-[30px] md:h-[68px] lg:px-[48px] lg:py-[30px] lg:h-[80px] inline-flex justify-between items-center">
            <Link
              href={langPrefix}
            ...
            <div className="justify-start items-center gap-40 hidden lg:flex">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className={`w-[12px] h-[6px] transition-transform duration-200 ${
            ...
            <div className="lg:hidden">
              <button onClick={toggleMobileMenu} className="p-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
                  <path d="M0 2H18" stroke={isMobileMenuOpen ? '#222222' : '#dddddd'} strokeWidth="2.5" />
                  <path d="M0 10H18" stroke={isMobileMenuOpen ? '#222222' : '#dddddd'} strokeWidth="2.5" />
                  <path d="M0 18H18" stroke={isMobileMenuOpen ? '#222222' : '#dddddd'} strokeWidth="2.5" />
                </svg>
              </button>
            </div>
          </div>
      ...
      <div className="w-full h-[58px] md:h-[68px] lg:h-[80px]" />
