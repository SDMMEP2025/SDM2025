...
export function Image({ Image = '/placeholder-image.jpg', altText = 'Main Image', isFirst = false }: ImageProps) {
  if (isFirst)
    return (
      <div className='w-full relative bg-gray-400 flex flex-col justify-center items-start'>
