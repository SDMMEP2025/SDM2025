//components/projects/Credit.tsx
...
export function Credit({ title = 'Designed By', members }: CreditProps) {
  ...
  return (
    ...
    >
      <div className='w-full flex flex-col justify-start items-start gap-[22px] md:gap-[16px] lg:gap-[24px]'>
        {/* 제목 */}
        ...
        {/* 멤버 그리드 */}
        <div className='w-full grid grid-cols-2 md:grid-cols-5 lg:grid-cols-5 gap-x-[14px] gap-y-[36px] md:gap-[7px] lg:gap-[5px] flex-wrap'>
          {members.map((member, index) => (
            <div key={index} className='flex flex-col justify-start items-start gap-2 gap-[8px] md:gap-3 lg:gap-[5px]'>
              {/* 프로필 이미지 */}
              <div className='w-full aspect-[176/240] md:aspect-[132/182] lg:aspect-[190/254] relative bg-white overflow-hidden'>
              ...
              <div className='w-full flex flex-col justify-start items-start gap-3'>
                ...
                <div className='w-full flex flex-col justify-start items-start'>
                  <div className='w-full flex justify-start items-center gap-1.5'>
                    <div className='text-neutral-800 text-base md:text-base lg:text-lg font-bold leading-[1.6] xs:leading-[1.6] md:leading-[1.5] lg:leading-[1.5] tracking-[-0.02em]'>
                      {member.name}
                    </div>
                  ...
                  <div className='w-full flex justify-start items-center gap-2 xs:gap-1 md:gap-1 lg:gap-1'>
                    {member.socialLinks?.instagram && (
                      <a
                        ...
                        className='w-[26px] h-[26px] md:w-[24px] md:h-[24px] lg:w-[30px] lg:h-[30px] text-zinc-600 hover:text-neutral-800 rounded flex items-center justify-center transition-colors duration-200'
                    ...
                    {member.socialLinks?.behance && (
                      <a
                        ...
                        target='_blank'
                        rel='noopener noreferrer'
                        className='w-[26px] h-[26px] md:w-[24px] md:h-[24px] lg:w-[30px] lg:h-[30px] bg-zinc-600 hover:bg-[#4B4F57] hover:bg-neutral-800 rounded flex items-center justify-center transition-colors duration-200'
                    ...
                    {member.socialLinks?.linkedin && (
                      <a
                        ...
                        target='_blank'
                        rel='noopener noreferrer'
                        className='w-[26px] h-[26px] md:w-[24px] md:h-[24px] lg:w-[30px] lg:h-[30px] text-[#4B4F57] bg-[#4B4F57] hover:text-neutral-800 hover:bg-neutral-800 rounded flex items-center justify-center transition-colors duration-200'
