...
export function ProjectNavigation({
 ...
 return (
   <div className="w-full flex flex-row justify-center items-center">
     <Link href={leftProject.linkUrl} className="relative w-full aspect-[720/400] cursor-pointer group">
       <img 
     ...
     <Link href={rightProject.linkUrl} className="relative w-full aspect-[720/400] cursor-pointer group">
       <img 
         className="object-cover w-full h-full"
