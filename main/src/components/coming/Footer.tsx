...
export function Footer() {
  return (
    <div className='w-full mix-blend-difference flex flex-col-reverse justify-between items-center gap-[12px] px-[61px] py-[12px] md:flex-row md:px-[40px] md:py-[12px] lg:px-[40px] lg:py-[28px]'>
      <div className='left-[40px] top-[28px] justify-start text-sm text-white mb-3 md:mb-0 text-center font-normal capitalize leading-normal md:text-left'>
        © 2025 Samsung Design Membership<span className='md:hidden'>.</span>
        <br className='md:hidden' />
        <span className='hidden md:inline'> </span>All rights reserved
      </div>
      <div className='hidden md:flex w-fit h-6 left-[1089px] top-[28px] justify-center items-center gap-10'>
        <a
