      ...
      >
        <div
          className={classNames(
            ...
            !title ? 'h-[0px]' : 'h-auto',
            //mobile
            'w-full text-[6.83vw] tracking-[-0.4px] leading-[1.1] font-bold',
            //tablet
            'md:w-[30%] md:text-[3.125vw] md:tracking-[-0.4px] md:leading-[1.1] md:whitespace-pre-line md:font-semibold',
            //desktop
            'lg:w-[30%] lg:text-[28px] lg:tracking-[-0.56px] lg:leading-[1.1] lg:whitespace-pre-line lg:font-semibold',
            //large desktop
            'xl:w-[30%] xl:text-[28px] xl:tracking-[-0.56px] xl:leading-[1.1] xl:whitespace-pre-line xl:font-semibold',
          )}
        >
          {title}
        </div>
