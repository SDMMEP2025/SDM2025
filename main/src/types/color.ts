...
export const REFINED_COLORS: RefinedColor[] = [
  { name: 'Energetic Red', hex: '#ED2E46', hueRange: [0, 20], brandColor: BRAND_COLORS.Pink },
  { name: 'Sunny Orange', hex: '#FF5500', hueRange: [20, 40], brandColor: BRAND_COLORS.Pink },
  { name: 'Mild Yellow', hex: '#FBE870', hueRange: [40, 60], brandColor: BRAND_COLORS.Pink },
  { name: 'Tender Apricot', hex: '#FFEFC2', hueRange: [60, 90], brandColor: BRAND_COLORS.Pink },
  { name: 'Cozy Melon', hex: '#E4FFD8', hueRange: [90, 120], brandColor: BRAND_COLORS.Yellow },
  ...
  { name: 'Candy Violet', hex: '#D700FF', hueRange: [260, 290], brandColor: BRAND_COLORS.Orange },
