...
const tutorData = [
  ...
  },
  {
    title: 'VD tutor',
    tutors: [
      { name: '장기성', englishName: 'Kisung Jang' },
    ],
  },
  {
    title: 'UX tutor',
...
하지만 혹시, 우리는 이 기다림으로 인해 떠나야 했던 타이밍을 놓치고 있는 것은 아닐까요?'
      ...
      <Divide title='Insight' number='02' />
      <TitleBody
        title={'다짐과 실행 사이,\n 감정의 시차'}
      ...
      />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Divide title='Hypothesis' number='03' />
      <MidTitle align='left' text='N년 후, 기술 발전이 만들어 갈 경험의 패러다임 변화' />
      ...
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Divide title='Project Overview' number='04' />
      <MidTitle align='center' text='Into the Moment, MIZI' />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <TitleBody
      ...
      />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Divide title='MIZI Avatar, NOMA' number='05' />
      <TitleBody
        title={'Avatar, NOMA'}
      ...
      />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <MidTitle align='center' text='Dive Into Your Desired Moment—Now, MIZI' />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Divide title='Feature 01' number='06' />
      <TitleBody
        title={'감정과 무드 기반의\n실시간 장소 큐레이션'}
      ...
      />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Divide title='Feature 02' number='07' />
      <TitleBody
        title={'이동이 자유로운\n연속적인 몰입 경험'}
      ...
      />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Divide title='Feature 03' number='08' />
      <TitleBody
        title={'On-Off\n하이브리드 경험'}
      ...
      />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Divide title='Feature 04' number='09' />
      <TitleBody
        title={'순간을 자동으로\n기록하는 아카이브'}
      ...
      />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <MidTitle align='center' text='Welcome to MIZI, an Unknown World' />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Divide title='Scenario 01' number='10' />
      <TitleBody
        title={'경직된 일상에서의 해방\n∞ Dune'}
      ...
      />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Divide title='Scenario 02' number='11' />
      <TitleBody
        title={'바다에 대한 갈망\n∞ Nautilus'}
      ...
      />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Divide title='Scenario 03' number='12' />
      <TitleBody
        title={'궁극의 미지에 대한 로망\n∞ Stardust'}
      ...
      />
      <Image Image='/images/projects/cruise/cruise_2.jpg' />
      <Divide title='Project Value' number='13' />
      <MidBody
        align='center'
        content={
          'MIZI는 기술의 발전이 이끌 ‘미래의 경험’을 새롭게 정의합니다. 모든 감각을 원격 실시간으로 완전히 재현할 수 있는 시대, 이제 우리는 일상에서 물리적 한계를 벗어나 원하는 곳 어디든 갈 수 있습니다. 불가능할 것만 같았던 장소까지 닿을 수 있죠. 이렇게 MIZI는 로망을 현실로 바꾸는 온 디맨드(On-Demand) 몰입 경험을 제안합니다.\n\n▶ Click here for more MIZI stories.'
        }
      />
      <Divide title='MIZI Branding Story' number='14' />
      <TitleBody
        title={'새로운 세계로,\n시야의 확장'}
