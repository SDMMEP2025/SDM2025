...
export function Footer() {
  return (
    <div className='absolute z-[200] bottom-0 w-full mix-blend-difference flex flex-col-reverse justify-between items-center gap-[12px] px-[61px] py-[24px] md:flex-row md:px-[40px] md:py-[12px] lg:px-[40px] lg:py-[28px]'>
